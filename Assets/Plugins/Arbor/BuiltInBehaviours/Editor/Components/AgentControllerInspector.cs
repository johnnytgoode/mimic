...
namespace ArborEditor
{
	...
	internal sealed class AgentControllerInspector : Editor
	{
		...
		SerializedProperty _SamplePositionEnabled;
		SerializedProperty _SamplePositionDistance;
		...
		void OnEnable()
		{
			...
			_SamplePositionEnabled = serializedObject.FindProperty("_SamplePositionEnabled");
			_SamplePositionDistance = serializedObject.FindProperty("_SamplePositionDistance");
		...
		public override void OnInspectorGUI()
		{
			...
			EditorGUILayout.Space();
			EditorGUILayout.LabelField("Sample Position", EditorStyles.boldLabel);
			EditorGUILayout.PropertyField(_SamplePositionEnabled);
			EditorGUILayout.PropertyField(_SamplePositionDistance);
